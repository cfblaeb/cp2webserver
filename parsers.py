...
def parse_cp2(data: DataFrame):
	...
	cp2_df['time'] = cp2_df['time'].dt.tz_localize('Europe/Copenhagen', ambiguous=True, nonexistent='shift_forward')  # localize to Denmark
...
def parse_cbs(data: DataFrame):
	...
	cbs_df['time'] = cbs_df['time'].dt.tz_localize('Europe/Copenhagen', ambiguous=True, nonexistent='shift_forward')  # localize to Denmark
